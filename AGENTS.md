...
- **Documentation Suite**: `apps/docs` (Sharity Master Document, `phases.md` roadmap, architecture, feature specs & guides)
...
│   └── docs/                    # Central Documentation Hub & Roadmap Specs
│       ├── README.md            # Master Documentation Index
│       ├── Sharity_Master_Document.md # Product Blueprint
│       ├── phases.md            # Interactive Phase Roadmap & Feature Checklist
│       ├── architecture/        # System, Database & API Specs
│       ├── features/            # Projects, Trust/Verification & Public Ledger Specs
│       └── guides/              # Developer & Admin Operations Guides
├── packages/
...
- **Documentation**: Keep `apps/docs/` updated when creating new feature routers, database entities, or operational flows.
